...
# PDF::Reader::Page, из которого можно дешево достать текст на случай
# если мы хотим найти например страницы с каким-то текстом и вынимать таблицы только из них
# если у Page позвать #tables, оно делает тяжелую работу и рендерит таблицы по мере сил
